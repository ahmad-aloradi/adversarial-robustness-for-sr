...
for eval_data in 'cnceleb'; do
    for eval_model in 'resnet34' 'ecapa_tdnn'; do
        ...
        sparsity_rate_test='sr[9][9]' # 'sr[7-9][0-9]'  'sr75' 'sr90', 'sr95', 'sr99'
        sparsity_rate='sr[9][9]' #  'sr[7-9][0-9]' 'sr75' 'sr90', 'sr95', 'sr99'
        ...
        experiments_struct_vs_unstruct_linbreg=(
            "sv_bregman_linbreg-wespeaker*${eval_model}*${eval_data}*${sparsity_rate}*${suffix_linbreg}"
            # "sv_bregman_linbreg-wespeaker*${eval_model}*${eval_data}*${sparsity_rate}*cls_scale2*"
            # "sv_bregman_linbreg_fixed-wespeaker*${eval_model}*${eval_data}*${sparsity_rate}*${suffix_fixed}"
            )
        experiments_struct_vs_unstruct_adabreg=(
            "sv_bregman_adabreg-wespeaker*${eval_model}*${eval_data}*${sparsity_rate}*${suffix_adabreg}"
        ...
        experiments_struct_vs_unstruct_pruning=(
            # "sv_pruning_mag_struct*${eval_model}*${eval_data}*${sparsity_rate}*"
            "sv_pruning_mag_unstruct*${eval_model}*${eval_data}*${sparsity_rate}*"
            )
