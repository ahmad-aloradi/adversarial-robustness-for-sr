...
TARGET_DURATION="${TARGET_DURATION:-5.0}"
MIN_DURATION="${MIN_DURATION:-0.5}"
MIN_CONCAT_DURATION="${MIN_CONCAT_DURATION:-2.0}"
...
echo "   Min concat duration: ${MIN_CONCAT_DURATION}s"
echo ""
...
CMD="PYTHONPATH=$(pwd) python scripts/datasets/concat_short_utterances.py \
    ...
    --min_concat_duration $MIN_CONCAT_DURATION \
